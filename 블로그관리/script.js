		...
		$menu.on("click", function(){
			if ( $("body").hasClass("mobile-menu") ){
				...
				if ( !$("#aside .profile").length ){
					$("#aside").append('<div class="profile" /><button type="button" class="close">ë‹«ê¸°</button>');
	...
	function coverSlider(){
		...
		$element.each(function(){
			...
			function slider(){
				...
				$cover.append('<button type="button" class="prev">ì´ì „</button><button type="button" class="next">ë‹¤ìŒ</button>');
			}
