...
HANJA_HUN_EUM = {
    ...
    "聚": "모을 취", "三": "석 삼", "軍": "군사 군", "衆": "무리 중", "投": "던질 투",
    "於": "어조사 어", "險": "험할 험", "此": "이 차", "謂": "이를 위", "將": "장수 장",
    "事": "일 사", "也": "어조사 야",
    "九": "아홉 구", "變": "변할 변", "屈": "굽힐 굴", "伸": "펼 신",
    "利": "이로울 리", "情": "뜻 정", "理": "다스릴 리", "可": "옳을 가",
    "察": "살필 찰",
    "凡": "무릇 범", "爲": "할 위", "客": "손 객", "道": "길 도",
    "則": "곧 즉", "專": "오로지 전", "淺": "얕을 천", "散": "흩을 산",
    "國": "나라 국", "越": "넘을 월", "境": "지경 경", "師": "스승 사",
    "者": "놈 자", "絶": "끊을 절", "四": "넉 사", "達": "통달할 달",
    "衢": "네거리 구", "重": "무거울 중", "輕": "가벼울 경", "背": "등 배",
    "固": "굳을 고", "前": "앞 전", "隘": "좁을 애", "圍": "에워쌀 위",
    "無": "없을 무", "死": "죽을 사",
    "是": "옳을 시", "故": "연고 고", "吾": "나 오", "志": "뜻 지", "屬": "붙일 속",
    "交": "사귈 교",
    "爭": "다툴 쟁", "趨": "달릴 추", "後": "뒤 후", "謹": "삼갈 근",
    "守": "지킬 수", "結": "맺을 결", "繼": "이을 계", "食": "밥 식",
    "圮": "무너질 비", "進": "나아갈 진", "塞": "막을 색", "闕": "대궐 궐",
    "示": "보일 시", "以": "써 이", "活": "살 활", "一": "한 일",
    "兵": "병사 병", "御": "막을 어", "已": "이미 이", "鬪": "싸울 투",
    "過": "지날 과", "從": "좇을 종", "謀": "꾀 모", "能": "능할 능",
    "預": "미리 예",
    "山": "메 산", "林": "수풀 림", "阻": "막힐 조", "沮": "막을 저",
    "澤": "못 택", "形": "모양 형", "行": "다닐 행", "用": "쓸 용",
    "鄕": "시골 향", "導": "이끌 도",
    "五": "다섯 오", "非": "아닐 비", "霸": "으뜸 패", "王": "임금 왕",
    "夫": "무릇 부", "伐": "칠 벌", "大": "큰 대", "威": "위엄 위",
    "加": "더할 가", "敵": "대적할 적", "合": "합할 합",
    "天": "하늘 천", "下": "아래 하", "養": "기를 양", "權": "권세 권",
    "信": "믿을 신", "己": "몸 기", "私": "사사 사",
    "城": "재 성", "拔": "뽑을 발", "隳": "무너뜨릴 휴", "施": "베풀 시",
    "法": "법 법", "賞": "상줄 상", "懸": "매달 현", "政": "정사 정",
    "令": "하여금 령", "犯": "범할 범",
    "勿": "말 물", "告": "고할 고", "言": "말씀 언", "害": "해로울 해",
}
